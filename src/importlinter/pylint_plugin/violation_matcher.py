...
class ViolationMatcher:
    ...
    def matches_violation_link(self, link: Dict[str, Any], current_module: str, 
        ...
        return (
            self._exact_match(current_module, imported_module,
                              violation_importer, violation_imported)
    ...
    def _exact_match(self, current_module: str, imported_module: str,
                     violation_importer: str, violation_imported: str) -> bool:
